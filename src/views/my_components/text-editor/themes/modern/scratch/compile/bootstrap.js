...
(function () {
  ...
  var reader = direct.create({
    sources: [
      source("bolt", "tinymce.themes.modern.Theme", ".", mapper.constant("theme")),
      source("bolt", "global!window", ".", mapper.constant("theme")),
      source("bolt", "tinymce.core.ThemeManager", ".", mapper.constant("theme")),
      source("bolt", "tinymce.themes.modern.api.ThemeApi", ".", mapper.constant("theme")),
      ...
      source("bolt", "tinymce.themes.modern.ui.Render", ".", mapper.constant("theme")),
      source("bolt", "tinymce.themes.modern.ui.Resize", ".", mapper.constant("theme")),
      ...
      source("bolt", "tinymce.themes.modern.api.Settings", ".", mapper.constant("theme")),
      source("bolt", "tinymce.themes.modern.modes.Iframe", ".", mapper.constant("theme")),
      source("bolt", "tinymce.themes.modern.modes.Inline", ".", mapper.constant("theme")),
      source("bolt", "tinymce.themes.modern.ui.ProgressState", ".", mapper.constant("theme")),
      source("bolt", "tinymce.themes.modern.api.Events", ".", mapper.constant("theme")),
      ...
      source("bolt", "tinymce.themes.modern.ui.A11y", ".", mapper.constant("theme")),
      source("bolt", "tinymce.themes.modern.ui.Branding", ".", mapper.constant("theme")),
      source("bolt", "tinymce.themes.modern.ui.ContextToolbars", ".", mapper.constant("theme")),
      source("bolt", "tinymce.themes.modern.ui.Menubar", ".", mapper.constant("theme")),
      source("bolt", "tinymce.themes.modern.ui.Sidebar", ".", mapper.constant("theme")),
      source("bolt", "tinymce.themes.modern.ui.SkinLoaded", ".", mapper.constant("theme")),
      source("bolt", "tinymce.themes.modern.ui.Toolbar", ".", mapper.constant("theme")),
