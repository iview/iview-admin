...
(function () {
  ...
  var reader = direct.create({
    sources: [
      source("bolt", "tinymce.themes.inlite.Theme", ".", mapper.constant("theme")),
      source("bolt", "global!window", ".", mapper.constant("theme")),
      source("bolt", "tinymce.core.ThemeManager", ".", mapper.constant("theme")),
      source("bolt", "tinymce.themes.inlite.api.ThemeApi", ".", mapper.constant("theme")),
      source("bolt", "tinymce.themes.inlite.ui.Buttons", ".", mapper.constant("theme")),
      source("bolt", "tinymce.themes.inlite.ui.Panel", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.Api", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.FormatControls", ".", mapper.constant("theme")),
      source("bolt", "global!tinymce.util.Tools.resolve", ".", mapper.constant("theme")),
      source("bolt", "tinymce.themes.inlite.core.Render", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.NotificationManagerImpl", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.WindowManagerImpl", ".", mapper.constant("theme")),
      source("bolt", "global!document", ".", mapper.constant("theme")),
      source("bolt", "tinymce.core.dom.DOMUtils", ".", mapper.constant("theme")),
      source("bolt", "tinymce.core.ui.Factory", ".", mapper.constant("theme")),
      source("bolt", "tinymce.core.util.Tools", ".", mapper.constant("theme")),
      source("bolt", "tinymce.themes.inlite.api.Events", ".", mapper.constant("theme")),
      source("bolt", "tinymce.themes.inlite.api.Settings", ".", mapper.constant("theme")),
      source("bolt", "tinymce.themes.inlite.core.Layout", ".", mapper.constant("theme")),
      source("bolt", "tinymce.themes.inlite.core.Measure", ".", mapper.constant("theme")),
      source("bolt", "tinymce.themes.inlite.ui.Forms", ".", mapper.constant("theme")),
      source("bolt", "tinymce.themes.inlite.ui.Toolbar", ".", mapper.constant("theme")),
      source("bolt", "tinymce.themes.inlite.file.Conversions", ".", mapper.constant("theme")),
      source("bolt", "tinymce.themes.inlite.file.Picker", ".", mapper.constant("theme")),
      source("bolt", "tinymce.themes.inlite.core.Actions", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.AbsoluteLayout", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.BrowseButton", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.Button", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.ButtonGroup", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.Checkbox", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.Collection", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.ColorBox", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.ColorButton", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.ColorPicker", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.ComboBox", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.Container", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.Control", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.DragHelper", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.DropZone", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.ElementPath", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.FieldSet", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.FilePicker", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.FitLayout", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.FlexLayout", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.FloatPanel", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.FlowLayout", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.Form", ".", mapper.constant("theme")),
      source("bolt", "ephox.katamari.api.Arr", ".", mapper.constant("theme")),
      source("bolt", "ephox.katamari.api.Fun", ".", mapper.constant("theme")),
      source("bolt", "ephox.sugar.api.node.Element", ".", mapper.constant("theme")),
      source("bolt", "ephox.sugar.api.search.SelectorFind", ".", mapper.constant("theme")),
      source("bolt", "tinymce.core.EditorManager", ".", mapper.constant("theme")),
      source("bolt", "tinymce.core.Env", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.fmt.FontInfo", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.Widget", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.FormItem", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.GridLayout", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.Iframe", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.InfoBox", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.KeyboardNavigation", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.Label", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.Layout", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.ListBox", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.Menu", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.MenuBar", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.MenuButton", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.MenuItem", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.MessageBox", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.Movable", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.Notification", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.Panel", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.PanelButton", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.Path", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.Progress", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.Radio", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.ReflowQueue", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.Resizable", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.ResizeHandle", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.Scrollable", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.SelectBox", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.Selector", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.Slider", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.Spacer", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.SplitButton", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.StackLayout", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.TabPanel", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.TextBox", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.Throbber", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.Toolbar", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.Tooltip", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.Window", ".", mapper.constant("theme")),
      source("bolt", "tinymce.core.util.Delay", ".", mapper.constant("theme")),
      source("bolt", "tinymce.themes.inlite.alien.Arr", ".", mapper.constant("theme")),
      source("bolt", "tinymce.themes.inlite.core.ElementMatcher", ".", mapper.constant("theme")),
      source("bolt", "tinymce.themes.inlite.core.Matcher", ".", mapper.constant("theme")),
      source("bolt", "tinymce.themes.inlite.core.PredicateId", ".", mapper.constant("theme")),
      source("bolt", "tinymce.themes.inlite.core.SelectionMatcher", ".", mapper.constant("theme")),
      source("bolt", "tinymce.themes.inlite.core.SkinLoader", ".", mapper.constant("theme")),
      source("bolt", "ephox.katamari.api.Option", ".", mapper.constant("theme")),
      source("bolt", "global!Array", ".", mapper.constant("theme")),
      source("bolt", "global!Error", ".", mapper.constant("theme")),
      source("bolt", "global!String", ".", mapper.constant("theme")),
      source("bolt", "global!setTimeout", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.DomUtils", ".", mapper.constant("theme")),
      source("bolt", "tinymce.core.dom.DomQuery", ".", mapper.constant("theme")),
      source("bolt", "tinymce.core.util.Class", ".", mapper.constant("theme")),
      source("bolt", "tinymce.core.util.EventDispatcher", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.BoxUtils", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.ClassList", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.data.ObservableObject", ".", mapper.constant("theme")),
      source("bolt", "tinymce.themes.inlite.alien.EditorSettings", ".", mapper.constant("theme")),
      source("bolt", "tinymce.core.geom.Rect", ".", mapper.constant("theme")),
      source("bolt", "tinymce.themes.inlite.core.Convert", ".", mapper.constant("theme")),
      source("bolt", "tinymce.core.util.Promise", ".", mapper.constant("theme")),
      source("bolt", "tinymce.themes.inlite.alien.Uuid", ".", mapper.constant("theme")),
      source("bolt", "tinymce.themes.inlite.alien.Unlink", ".", mapper.constant("theme")),
      source("bolt", "tinymce.themes.inlite.core.UrlType", ".", mapper.constant("theme")),
      source("bolt", "tinymce.themes.inlite.alien.Type", ".", mapper.constant("theme")),
      source("bolt", "ephox.sand.api.FileReader", ".", mapper.constant("theme")),
      source("bolt", "global!RegExp", ".", mapper.constant("theme")),
      source("bolt", "tinymce.core.util.VK", ".", mapper.constant("theme")),
      source("bolt", "tinymce.core.util.Color", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.content.LinkTargets", ".", mapper.constant("theme")),
      source("bolt", "global!console", ".", mapper.constant("theme")),
      source("bolt", "ephox.sugar.api.search.PredicateFind", ".", mapper.constant("theme")),
      source("bolt", "ephox.sugar.api.search.Selectors", ".", mapper.constant("theme")),
      source("bolt", "ephox.sugar.impl.ClosestOrAncestor", ".", mapper.constant("theme")),
      source("bolt", "ephox.sugar.api.node.Node", ".", mapper.constant("theme")),
      source("bolt", "global!Object", ".", mapper.constant("theme")),
      source("bolt", "tinymce.ui.data.Binding", ".", mapper.constant("theme")),
      source("bolt", "tinymce.core.util.Observable", ".", mapper.constant("theme")),
      source("bolt", "tinymce.themes.inlite.alien.Bookmark", ".", mapper.constant("theme")),
      source("bolt", "tinymce.core.dom.TreeWalker", ".", mapper.constant("theme")),
      source("bolt", "tinymce.core.dom.RangeUtils", ".", mapper.constant("theme")),
      source("bolt", "ephox.sand.util.Global", ".", mapper.constant("theme")),
      source("bolt", "ephox.katamari.api.Id", ".", mapper.constant("theme")),
      source("bolt", "ephox.sugar.api.search.SelectorFilter", ".", mapper.constant("theme")),
      source("bolt", "ephox.katamari.api.Type", ".", mapper.constant("theme")),
      source("bolt", "ephox.sugar.api.node.Body", ".", mapper.constant("theme")),
      source("bolt", "ephox.sugar.api.dom.Compare", ".", mapper.constant("theme")),
      source("bolt", "ephox.sugar.api.node.NodeTypes", ".", mapper.constant("theme")),
      source("bolt", "ephox.katamari.api.Resolve", ".", mapper.constant("theme")),
      source("bolt", "global!Date", ".", mapper.constant("theme")),
      source("bolt", "global!Math", ".", mapper.constant("theme")),
      source("bolt", "ephox.sugar.api.search.PredicateFilter", ".", mapper.constant("theme")),
      source("bolt", "ephox.katamari.api.Thunk", ".", mapper.constant("theme")),
      source("bolt", "ephox.sand.api.Node", ".", mapper.constant("theme")),
      source("bolt", "ephox.sand.api.PlatformDetection", ".", mapper.constant("theme")),
      source("bolt", "ephox.katamari.api.Global", ".", mapper.constant("theme")),
      source("bolt", "ephox.sugar.api.search.Traverse", ".", mapper.constant("theme")),
      source("bolt", "ephox.sand.core.PlatformDetection", ".", mapper.constant("theme")),
      source("bolt", "global!navigator", ".", mapper.constant("theme")),
      source("bolt", "ephox.katamari.api.Struct", ".", mapper.constant("theme")),
      source("bolt", "ephox.sugar.alien.Recurse", ".", mapper.constant("theme")),
      source("bolt", "ephox.sand.core.Browser", ".", mapper.constant("theme")),
      source("bolt", "ephox.sand.core.OperatingSystem", ".", mapper.constant("theme")),
      source("bolt", "ephox.sand.detect.DeviceType", ".", mapper.constant("theme")),
      source("bolt", "ephox.sand.detect.UaString", ".", mapper.constant("theme")),
      source("bolt", "ephox.sand.info.PlatformInfo", ".", mapper.constant("theme")),
      source("bolt", "ephox.katamari.data.Immutable", ".", mapper.constant("theme")),
      source("bolt", "ephox.katamari.data.MixedBag", ".", mapper.constant("theme")),
      source("bolt", "ephox.sand.detect.Version", ".", mapper.constant("theme")),
      source("bolt", "ephox.katamari.api.Strings", ".", mapper.constant("theme")),
      source("bolt", "ephox.katamari.api.Obj", ".", mapper.constant("theme")),
      source("bolt", "ephox.katamari.util.BagUtils", ".", mapper.constant("theme")),
      source("bolt", "global!Number", ".", mapper.constant("theme")),
      source("bolt", "ephox.katamari.str.StrAppend", ".", mapper.constant("theme")),
      source("bolt", "ephox.katamari.str.StringParts", ".", mapper.constant("theme"))
    ]
  });
