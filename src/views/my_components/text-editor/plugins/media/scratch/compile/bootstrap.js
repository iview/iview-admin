...
(function () {
  ...
  var reader = direct.create({
    sources: [
      source("bolt", "tinymce.plugins.media.Plugin", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.PluginManager", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.media.api.Api", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.media.api.Commands", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.media.core.FilterContent", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.media.core.ResolveName", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.media.core.Selection", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.media.ui.Buttons", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.util.Tools.resolve", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.media.ui.Dialog", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.html.Node", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.util.Tools", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.media.core.Nodes", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.media.core.Sanitize", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.media.core.UpdateHtml", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.Env", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.util.Delay", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.media.api.Settings", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.media.core.HtmlToData", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.media.core.Service", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.media.core.Size", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.html.Writer", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.html.SaxParser", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.html.Schema", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.dom.DOMUtils", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.media.ui.SizeManager", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.media.core.VideoScript", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.util.Promise", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.media.core.DataToHtml", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.media.core.Mime", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.media.core.UrlPatterns", ".", mapper.constant("plugin"))
    ]
  });
