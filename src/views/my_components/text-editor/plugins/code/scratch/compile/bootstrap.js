...
(function () {
  ...
  var reader = direct.create({
    sources: [
      source("bolt", "tinymce.plugins.code.Plugin", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.PluginManager", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.code.api.Commands", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.code.ui.Buttons", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.util.Tools.resolve", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.code.ui.Dialog", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.code.api.Settings", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.code.core.Content", ".", mapper.constant("plugin")),
