...
(function () {
  ...
  var reader = direct.create({
    sources: [
      source("bolt", "tinymce.plugins.fullscreen.Plugin", ".", mapper.constant("plugin")),
      source("bolt", "ephox.katamari.api.Cell", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.PluginManager", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.fullscreen.api.Api", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.fullscreen.api.Commands", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.fullscreen.ui.Buttons", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.util.Tools.resolve", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.fullscreen.core.Actions", ".", mapper.constant("plugin")),
      ...
      source("bolt", "tinymce.plugins.fullscreen.api.Events", ".", mapper.constant("plugin"))
    ]
  });
