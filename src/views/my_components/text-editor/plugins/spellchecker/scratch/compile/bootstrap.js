...
(function () {
  ...
  var reader = direct.create({
    sources: [
      source("bolt", "tinymce.plugins.spellchecker.Plugin", ".", mapper.constant("plugin")),
      source("bolt", "ephox.katamari.api.Cell", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.PluginManager", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.spellchecker.api.Api", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.spellchecker.api.Commands", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.spellchecker.api.Settings", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.spellchecker.core.DetectProPlugin", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.spellchecker.ui.Buttons", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.spellchecker.ui.SuggestionsMenu", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.util.Tools.resolve", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.spellchecker.core.Actions", ".", mapper.constant("plugin")),
      ...
      source("bolt", "tinymce.plugins.spellchecker.api.Events", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.spellchecker.core.DomTextMatcher", ".", mapper.constant("plugin"))
    ]
  });
