...
(function () {
  ...
  var reader = direct.create({
    sources: [
      source("bolt", "tinymce.plugins.pagebreak.Plugin", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.Env", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.PluginManager", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.pagebreak.api.Commands", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.pagebreak.core.FilterContent", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.pagebreak.core.ResolveName", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.pagebreak.ui.Buttons", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.util.Tools.resolve", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.pagebreak.api.Settings", ".", mapper.constant("plugin"))
    ]
  });
