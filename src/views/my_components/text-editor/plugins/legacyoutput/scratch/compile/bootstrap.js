...
(function () {
  ...
  var reader = direct.create({
    sources: [
      source("bolt", "tinymce.plugins.legacyoutput.Plugin", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.PluginManager", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.legacyoutput.core.Formats", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.legacyoutput.ui.Buttons", ".", mapper.constant("plugin")),
