...
(function () {
  ...
  var reader = direct.create({
    sources: [
      source("bolt", "tinymce.plugins.save.Plugin", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.PluginManager", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.save.api.Commands", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.save.ui.Buttons", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.util.Tools.resolve", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.save.core.Actions", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.save.api.Settings", ".", mapper.constant("plugin")),
