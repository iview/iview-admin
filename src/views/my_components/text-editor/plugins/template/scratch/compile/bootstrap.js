...
(function () {
  ...
  var reader = direct.create({
    sources: [
      source("bolt", "tinymce.plugins.template.Plugin", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.PluginManager", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.template.api.Commands", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.template.core.FilterContent", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.template.ui.Buttons", ".", mapper.constant("plugin")),
      ...
      source("bolt", "tinymce.plugins.template.core.Templates", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.util.Tools", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.template.api.Settings", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.template.core.DateTimeHelper", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.template.ui.Dialog", ".", mapper.constant("plugin")),
