...
(function () {
  ...
  var reader = direct.create({
    sources: [
      source("bolt", "tinymce.plugins.table.Plugin", ".", mapper.constant("plugin")),
      ...
      source("bolt", "tinymce.plugins.table.model.TableGrid", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.table.selection.CellSelection", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.table.ui.Dialogs", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.table.ui.ResizeBars", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.table.util.Utils", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.table.util.Quirks", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.util.Tools.resolve", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.table.model.SplitCols", ".", mapper.constant("plugin")),
