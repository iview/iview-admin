...
(function () {
  ...
  var reader = direct.create({
    sources: [
      source("bolt", "tinymce.plugins.toc.Plugin", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.PluginManager", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.toc.api.Commands", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.toc.api.Settings", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.toc.core.FilterContent", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.toc.ui.Buttons", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.util.Tools.resolve", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.toc.core.Toc", ".", mapper.constant("plugin")),
      ...
      source("bolt", "tinymce.plugins.toc.core.Guid", ".", mapper.constant("plugin"))
    ]
  });
