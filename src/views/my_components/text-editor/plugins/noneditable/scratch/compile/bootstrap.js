...
(function () {
  ...
  var reader = direct.create({
    sources: [
      source("bolt", "tinymce.plugins.noneditable.Plugin", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.PluginManager", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.noneditable.core.FilterContent", ".", mapper.constant("plugin")),
      ...
      source("bolt", "tinymce.plugins.noneditable.api.Settings", ".", mapper.constant("plugin"))
    ]
  });
