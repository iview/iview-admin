...
(function () {
  ...
  var reader = direct.create({
    sources: [
      source("bolt", "tinymce.plugins.imagetools.Plugin", ".", mapper.constant("plugin")),
      source("bolt", "ephox.katamari.api.Cell", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.PluginManager", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.imagetools.api.Commands", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.imagetools.core.UploadSelectedImage", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.imagetools.ui.Buttons", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.imagetools.ui.ContextToolbar", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.util.Tools.resolve", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.util.Tools", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.imagetools.core.Actions", ".", mapper.constant("plugin")),
      source("bolt", "ephox.katamari.api.Fun", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.imagetools.api.Settings", ".", mapper.constant("plugin")),
      ...
      source("bolt", "global!Array", ".", mapper.constant("plugin")),
      source("bolt", "global!Error", ".", mapper.constant("plugin")),
      source("bolt", "ephox.sand.api.URL", ".", mapper.constant("plugin")),
      source("bolt", "global!clearTimeout", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.util.Delay", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.util.Promise", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.util.URI", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.imagetools.core.ImageSize", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.imagetools.core.Proxy", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.imagetools.ui.Dialog", ".", mapper.constant("plugin")),
      source("bolt", "ephox.imagetools.util.Conversions", ".", mapper.constant("plugin")),
      source("bolt", "ephox.imagetools.util.ImageResult", ".", mapper.constant("plugin")),
      ...
      source("bolt", "ephox.sand.util.Global", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.imagetools.core.Errors", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.imagetools.core.Utils", ".", mapper.constant("plugin")),
      source("bolt", "global!Math", ".", mapper.constant("plugin")),
      source("bolt", "global!setTimeout", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.dom.DOMUtils", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.ui.Factory", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.imagetools.core.UndoStack", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.imagetools.ui.ImagePanel", ".", mapper.constant("plugin")),
      ...
      source("bolt", "ephox.katamari.api.Resolve", ".", mapper.constant("plugin")),
      source("bolt", "ephox.katamari.api.Arr", ".", mapper.constant("plugin")),
      source("bolt", "ephox.sand.api.FileReader", ".", mapper.constant("plugin")),
      source("bolt", "ephox.sand.api.XMLHttpRequest", ".", mapper.constant("plugin")),
      source("bolt", "global!document", ".", mapper.constant("plugin")),
      source("bolt", "global!Image", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.geom.Rect", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.imagetools.core.LoadImage", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.imagetools.ui.CropRect", ".", mapper.constant("plugin")),
      source("bolt", "ephox.katamari.api.Global", ".", mapper.constant("plugin")),
      source("bolt", "ephox.katamari.api.Option", ".", mapper.constant("plugin")),
      source("bolt", "global!String", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.dom.DomQuery", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.util.Observable", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.util.VK", ".", mapper.constant("plugin")),
      source("bolt", "global!Object", ".", mapper.constant("plugin"))
    ]
  });
