...
(function () {
  ...
  var reader = direct.create({
    sources: [
      source("bolt", "tinymce.plugins.textcolor.Plugin", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.PluginManager", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.textcolor.ui.Buttons", ".", mapper.constant("plugin")),
      ...
      source("bolt", "tinymce.plugins.textcolor.api.Settings", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.textcolor.core.TextColor", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.textcolor.ui.ColorPickerHtml", ".", mapper.constant("plugin")),
