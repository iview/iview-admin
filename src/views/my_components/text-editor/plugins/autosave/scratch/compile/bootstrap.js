...
(function () {
  ...
  var reader = direct.create({
    sources: [
      source("bolt", "tinymce.plugins.autosave.Plugin", ".", mapper.constant("plugin")),
      source("bolt", "ephox.katamari.api.Cell", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.PluginManager", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.autosave.api.Api", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.autosave.core.BeforeUnload", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.autosave.ui.Buttons", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.util.Tools.resolve", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.autosave.core.Storage", ".", mapper.constant("plugin")),
      ...
      source("bolt", "tinymce.plugins.autosave.api.Settings", ".", mapper.constant("plugin")),
      source("bolt", "global!setInterval", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.util.LocalStorage", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.autosave.api.Events", ".", mapper.constant("plugin")),
      source("bolt", "global!document", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.autosave.core.Time", ".", mapper.constant("plugin"))
    ]
  });
