...
(function () {
  ...
  var reader = direct.create({
    sources: [
      source("bolt", "tinymce.plugins.lists.Plugin", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.PluginManager", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.lists.api.Api", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.lists.api.Commands", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.lists.core.Keyboard", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.lists.ui.Buttons", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.util.Tools.resolve", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.lists.core.Delete", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.lists.actions.Indent", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.lists.actions.Outdent", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.lists.actions.ToggleList", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.util.VK", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.lists.api.Settings", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.util.Tools", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.lists.core.NodeType", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.lists.core.Selection", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.dom.RangeUtils", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.dom.TreeWalker", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.dom.BookmarkManager", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.dom.DOMUtils", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.lists.core.Bookmark", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.lists.core.NormalizeLists", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.dom.DomQuery", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.lists.core.SplitList", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.lists.core.TextBlock", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.lists.core.Range", ".", mapper.constant("plugin")),
