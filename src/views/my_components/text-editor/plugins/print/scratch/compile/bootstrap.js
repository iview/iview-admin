...
(function () {
  ...
  var reader = direct.create({
    sources: [
      source("bolt", "tinymce.plugins.print.Plugin", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.PluginManager", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.print.api.Commands", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.print.ui.Buttons", ".", mapper.constant("plugin")),
