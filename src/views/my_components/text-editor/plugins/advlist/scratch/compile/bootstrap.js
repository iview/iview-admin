...
(function () {
  ...
  var reader = direct.create({
    sources: [
      source("bolt", "tinymce.plugins.advlist.Plugin", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.PluginManager", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.util.Tools", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.advlist.api.Commands", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.advlist.ui.Buttons", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.util.Tools.resolve", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.advlist.core.Actions", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.advlist.api.Settings", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.advlist.core.ListUtils", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.advlist.ui.ListStyles", ".", mapper.constant("plugin"))
    ]
  });
