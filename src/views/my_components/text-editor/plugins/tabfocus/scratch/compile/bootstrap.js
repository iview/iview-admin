...
(function () {
  ...
  var reader = direct.create({
    sources: [
      source("bolt", "tinymce.plugins.tabfocus.Plugin", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.PluginManager", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.tabfocus.core.Keyboard", ".", mapper.constant("plugin")),
      ...
      source("bolt", "tinymce.plugins.tabfocus.api.Settings", ".", mapper.constant("plugin"))
    ]
  });
