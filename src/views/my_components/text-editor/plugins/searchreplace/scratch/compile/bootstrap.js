...
(function () {
  ...
  var reader = direct.create({
    sources: [
      source("bolt", "tinymce.plugins.searchreplace.Plugin", ".", mapper.constant("plugin")),
      source("bolt", "ephox.katamari.api.Cell", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.PluginManager", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.searchreplace.api.Api", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.searchreplace.api.Commands", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.searchreplace.ui.Buttons", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.util.Tools.resolve", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.searchreplace.core.Actions", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.searchreplace.ui.Dialog", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.util.Tools", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.searchreplace.core.FindReplaceText", ".", mapper.constant("plugin"))
    ]
  });
