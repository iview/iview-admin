...
(function () {
  ...
  var reader = direct.create({
    sources: [
      source("bolt", "tinymce.plugins.contextmenu.Plugin", ".", mapper.constant("plugin")),
      source("bolt", "ephox.katamari.api.Cell", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.PluginManager", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.contextmenu.api.Api", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.contextmenu.core.Bind", ".", mapper.constant("plugin")),
      ...
      source("bolt", "tinymce.plugins.contextmenu.api.Settings", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.contextmenu.core.RangePoint", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.contextmenu.ui.ContextMenu", ".", mapper.constant("plugin")),
