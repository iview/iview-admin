...
(function () {
  ...
  var reader = direct.create({
    sources: [
      source("bolt", "tinymce.plugins.image.Plugin", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.PluginManager", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.image.api.Commands", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.image.core.FilterContent", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.image.ui.Buttons", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.util.Tools.resolve", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.image.ui.Dialog", ".", mapper.constant("plugin")),
      ...
      source("bolt", "global!RegExp", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.Env", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.ui.Factory", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.util.JSON", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.util.XHR", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.image.api.Settings", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.image.core.Uploader", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.image.core.Utils", ".", mapper.constant("plugin")),
