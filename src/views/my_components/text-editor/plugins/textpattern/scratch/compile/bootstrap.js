...
(function () {
  ...
  var reader = direct.create({
    sources: [
      source("bolt", "tinymce.plugins.textpattern.Plugin", ".", mapper.constant("plugin")),
      source("bolt", "ephox.katamari.api.Cell", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.PluginManager", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.textpattern.api.Api", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.textpattern.api.Settings", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.textpattern.core.Keyboard", ".", mapper.constant("plugin")),
      ...
      source("bolt", "tinymce.plugins.textpattern.core.KeyHandler", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.textpattern.core.Formatter", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.dom.TreeWalker", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.util.Tools", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.textpattern.core.Patterns", ".", mapper.constant("plugin"))
    ]
  });
