...
(function () {
  ...
  var reader = direct.create({
    sources: [
      source("bolt", "tinymce.plugins.hr.Plugin", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.PluginManager", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.hr.api.Commands", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.hr.ui.Buttons", ".", mapper.constant("plugin")),
