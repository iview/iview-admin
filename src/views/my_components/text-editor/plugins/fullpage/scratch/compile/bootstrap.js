...
(function () {
  ...
  var reader = direct.create({
    sources: [
      source("bolt", "tinymce.plugins.fullpage.Plugin", ".", mapper.constant("plugin")),
      source("bolt", "ephox.katamari.api.Cell", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.PluginManager", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.fullpage.api.Commands", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.fullpage.core.FilterContent", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.fullpage.ui.Buttons", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.util.Tools.resolve", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.fullpage.ui.Dialog", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.util.Tools", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.fullpage.api.Settings", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.fullpage.core.Parser", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.fullpage.core.Protect", ".", mapper.constant("plugin")),
