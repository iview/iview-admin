...
(function () {
  ...
  var reader = direct.create({
    sources: [
      source("bolt", "tinymce.plugins.help.Plugin", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.PluginManager", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.help.api.Commands", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.help.ui.Buttons", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.help.ui.Dialog", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.util.Tools.resolve", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.EditorManager", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.help.ui.KeyboardShortcutsTab", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.help.ui.PluginsTab", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.help.ui.ButtonsRow", ".", mapper.constant("plugin")),
      source("bolt", "ephox.katamari.api.Arr", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.util.I18n", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.help.data.KeyboardShortcuts", ".", mapper.constant("plugin")),
      source("bolt", "ephox.katamari.api.Fun", ".", mapper.constant("plugin")),
      source("bolt", "ephox.katamari.api.Obj", ".", mapper.constant("plugin")),
      source("bolt", "ephox.katamari.api.Strings", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.help.data.PluginUrls", ".", mapper.constant("plugin")),
      ...
      source("bolt", "ephox.katamari.str.StrAppend", ".", mapper.constant("plugin")),
      source("bolt", "ephox.katamari.str.StringParts", ".", mapper.constant("plugin"))
    ]
  });
