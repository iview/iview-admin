...
(function () {
  ...
  var reader = direct.create({
    sources: [
      source("bolt", "tinymce.plugins.paste.Plugin", ".", mapper.constant("plugin")),
      source("bolt", "ephox.katamari.api.Cell", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.PluginManager", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.paste.api.Api", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.paste.api.Commands", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.paste.core.Clipboard", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.paste.core.CutCopy", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.paste.core.DragDrop", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.paste.core.PrePostProcess", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.paste.core.Quirks", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.paste.ui.Buttons", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.spellchecker.core.DetectProPlugin", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.util.Tools.resolve", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.paste.core.Actions", ".", mapper.constant("plugin")),
      source("bolt", "global!Image", ".", mapper.constant("plugin")),
      source("bolt", "global!navigator", ".", mapper.constant("plugin")),
      source("bolt", "global!window", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.Env", ".", mapper.constant("plugin")),
      ...
      source("bolt", "tinymce.plugins.paste.api.Events", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.paste.core.InternalHtml", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.paste.core.Newlines", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.paste.core.PasteBin", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.paste.core.ProcessFilters", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.paste.core.SmartPaste", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.paste.core.Utils", ".", mapper.constant("plugin")),
      source("bolt", "global!setTimeout", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.dom.RangeUtils", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.paste.api.Settings", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.paste.core.WordFilter", ".", mapper.constant("plugin")),
      source("bolt", "ephox.katamari.api.Fun", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.html.Entities", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.html.DomParser", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.html.Node", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.html.Schema", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.html.Serializer", ".", mapper.constant("plugin")),
