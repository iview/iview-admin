...
(function () {
  ...
  var reader = direct.create({
    sources: [
      source("bolt", "tinymce.plugins.wordcount.Plugin", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.PluginManager", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.wordcount.api.Api", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.wordcount.ui.Statusbar", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.util.Tools.resolve", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.wordcount.text.WordCount", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.util.Delay", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.wordcount.text.WordGetter", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.wordcount.text.UnicodeData", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.wordcount.text.StringMapper", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.wordcount.text.WordBoundary", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.wordcount.alien.Arr", ".", mapper.constant("plugin"))
    ]
  });
