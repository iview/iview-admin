...
(function () {
  ...
  var reader = direct.create({
    sources: [
      source("bolt", "tinymce.plugins.autoresize.Plugin", ".", mapper.constant("plugin")),
      source("bolt", "ephox.katamari.api.Cell", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.PluginManager", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.autoresize.api.Commands", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.autoresize.core.Resize", ".", mapper.constant("plugin")),
      ...
      source("bolt", "tinymce.plugins.autoresize.api.Settings", ".", mapper.constant("plugin"))
    ]
  });
