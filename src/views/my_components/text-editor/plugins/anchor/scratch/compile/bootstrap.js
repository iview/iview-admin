...
(function () {
  ...
  var reader = direct.create({
    sources: [
      source("bolt", "tinymce.plugins.anchor.Plugin", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.PluginManager", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.anchor.api.Commands", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.anchor.core.FilterContent", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.anchor.ui.Buttons", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.util.Tools.resolve", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.anchor.ui.Dialog", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.anchor.core.Anchor", ".", mapper.constant("plugin"))
    ]
  });
