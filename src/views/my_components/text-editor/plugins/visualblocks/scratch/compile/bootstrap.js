...
(function () {
  ...
  var reader = direct.create({
    sources: [
      source("bolt", "tinymce.plugins.visualblocks.Plugin", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.PluginManager", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.visualblocks.api.Commands", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.visualblocks.core.Bindings", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.visualblocks.ui.Buttons", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.util.Tools.resolve", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.visualblocks.core.VisualBlocks", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.visualblocks.api.Settings", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.visualblocks.api.Events", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.visualblocks.core.LoadCss", ".", mapper.constant("plugin")),
