...
(function () {
  ...
  var reader = direct.create({
    sources: [
      source("bolt", "tinymce.plugins.preview.Plugin", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.PluginManager", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.preview.api.Commands", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.preview.ui.Buttons", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.util.Tools.resolve", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.preview.ui.Dialog", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.Env", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.util.Tools", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.preview.api.Settings", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.preview.ui.IframeContent", ".", mapper.constant("plugin"))
    ]
  });
