...
(function () {
  ...
  var reader = direct.create({
    sources: [
      source("bolt", "tinymce.plugins.insertdatetime.Plugin", ".", mapper.constant("plugin")),
      source("bolt", "ephox.katamari.api.Cell", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.PluginManager", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.insertdatetime.api.Commands", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.insertdatetime.ui.Buttons", ".", mapper.constant("plugin")),
      ...
      source("bolt", "tinymce.plugins.insertdatetime.core.Actions", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.util.Tools", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.insertdatetime.api.Settings", ".", mapper.constant("plugin"))
    ]
  });
