...
(function () {
  ...
  var reader = direct.create({
    sources: [
      source("bolt", "tinymce.plugins.link.Plugin", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.PluginManager", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.link.api.Commands", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.link.core.Actions", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.link.core.Keyboard", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.link.ui.Controls", ".", mapper.constant("plugin")),
      ...
      source("bolt", "tinymce.plugins.link.api.Settings", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.link.core.OpenUrl", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.link.core.Utils", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.link.ui.Dialog", ".", mapper.constant("plugin")),
