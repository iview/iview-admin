...
(function () {
  ...
  var reader = direct.create({
    sources: [
      source("bolt", "tinymce.plugins.charmap.Plugin", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.PluginManager", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.charmap.api.Api", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.charmap.api.Commands", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.charmap.ui.Buttons", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.util.Tools.resolve", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.charmap.core.Actions", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.charmap.core.CharMap", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.charmap.ui.Dialog", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.charmap.api.Events", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.util.Tools", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.charmap.api.Settings", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.charmap.ui.GridHtml", ".", mapper.constant("plugin"))
    ]
  });
