...
(function () {
  ...
  var reader = direct.create({
    sources: [
      source("bolt", "tinymce.plugins.visualchars.Plugin", ".", mapper.constant("plugin")),
      source("bolt", "ephox.katamari.api.Cell", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.PluginManager", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.visualchars.api.Api", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.visualchars.api.Commands", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.visualchars.core.Keyboard", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.visualchars.ui.Buttons", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.util.Tools.resolve", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.visualchars.core.Actions", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.util.Delay", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.visualchars.core.VisualChars", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.visualchars.api.Events", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.visualchars.core.Data", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.visualchars.core.Nodes", ".", mapper.constant("plugin")),
      source("bolt", "ephox.katamari.api.Arr", ".", mapper.constant("plugin")),
      source("bolt", "ephox.sugar.api.node.Element", ".", mapper.constant("plugin")),
      source("bolt", "ephox.sugar.api.node.Node", ".", mapper.constant("plugin")),
      ...
      source("bolt", "global!console", ".", mapper.constant("plugin")),
      source("bolt", "global!document", ".", mapper.constant("plugin")),
      source("bolt", "ephox.sugar.api.node.NodeTypes", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.plugins.visualchars.core.Html", ".", mapper.constant("plugin")),
