...
<template>
    <div ref="scrollCon" @DOMMouseScroll="handlescroll" @mousewheel="handlescroll" class="tags-outer-scroll-con">
        <div class="tags-inner-btn left-tag-con" @click="preTagsPage">
            <Icon type="chevron-left" size="20"></Icon>
        </div>
        <div class="tags-inner-btn right-tag-con" @click="nextTagsPage">
            <Icon type="chevron-right" size="20"></Icon>
        </div>
        <div class="tags-inner-btn close-all-tag-con">
