  ...
  <div>
    <Card>
        <div class="search-con search-con-top">
            资源状态：
            <Select v-model="query.res_enable" class="search-col">
            ...
            <Button @click="handleGetRess" class="search-btn" type="primary"><Icon type="search"/>搜索</Button>
    ...
    <Drawer title="编辑资源" v-model="drawer.edit" width="720" :mask-closable="true" >
        <Form ref="form.edit" :model="form.edit" :rules="rules.edit">
            <Row :gutter="32">
                <Col span="12">
                    <FormItem label="资源代码：" prop="res_code" label-position="left">
...
export default {
  ...
  data () {
    return {
        ...
        columns: [
            {title: 'ID',key: 'id'},
            {title: '资源代码',key: 'res_code'},
            {title: '资源名称',key: 'res_name'},
            {title: '资源类型',key: 'res_type'},
            {title: '资源URL',key: 'res_url'},
            {
                title: '状态',
                key: 'res_enable',
                width: 150,
